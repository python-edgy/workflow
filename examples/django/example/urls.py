...
from example.workflow_app.views import IssueListView, IssueCreateView, IssueDetailView, \
    IssueTransitionView
...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/transition/(?P<transition>[\w-]+)$', IssueTransitionView.as_view(),
